...
public class ModItems {
    ...
    public static final DeferredItem<Item> CHANNEL_METER =
            ITEMS.register("channel_meter",
                    () -> new Item(new Item.Properties()));

    public static final DeferredItem<ColoredPartItem<AmplifiedCablePart>> AMPLIFIED_CABLE =
            ITEMS.register("amplified_cable",
                    () -> new ColoredPartItem<>(
    ...
    public static final DeferredItem<ColoredPartItem<AmplifiedCablePart128>> AMPLIFIED_CABLE_128 =
            ITEMS.register("amplified_cable_128",
                    () -> new ColoredPartItem<>(
                            new Item.Properties().component(
                                    DataComponents.LORE,
                                    new ItemLore(List.of(
    ...
    public static final DeferredItem<ColoredPartItem<AmplifiedCablePart256>> AMPLIFIED_CABLE_256 =
            ITEMS.register("amplified_cable_256",
                    () -> new ColoredPartItem<>(
                            new Item.Properties().component(
                                    DataComponents.LORE,
                                    new ItemLore(List.of(
